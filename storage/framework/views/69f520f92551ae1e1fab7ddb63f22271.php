            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <?php if(!auth()->user()->is_play_account): ?>
                        <form method="POST" action="<?php echo e(route('leagues.update', $league)); ?>" class="space-y-6 mb-8">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PATCH'); ?>
                            <div>
                                <label for="name" class="block mb-1 font-medium">Name</label>
                                <input type="text" name="name" id="name" value="<?php echo e($league->name); ?>" required class="w-full rounded border-gray-300 dark:bg-gray-700 dark:text-gray-100 px-3 py-2 focus:ring focus:ring-blue-200">
                            </div>
                            <div>
                                <button type="submit" class="px-6 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Update</button>
                                <a href="<?php echo e(route('leagues.index')); ?>" class="ml-4 text-blue-600 hover:underline">Back</a>
                            </div>
                        </form>
                    <?php else: ?>
                        ...
                        <ul class="mb-4">
                            <?php $__empty_1 = true; $__currentLoopData = $league->teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <li class="py-2 border-b last:border-b-0 flex justify-between items-center">
                                    ...
                                    <form method="POST" action="<?php echo e(route('teams.destroy', $team)); ?>" onsubmit="return confirm('Remove this team from the league?');">
                                        <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\xamp\webdav\puck_logic\laravel_new\resources\views/leagues/edit.blade.php ENDPATH**/ ?>